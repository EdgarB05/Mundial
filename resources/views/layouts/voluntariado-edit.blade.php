...
<head>
    ...
    <title>Editar voluntariado - Mundial 2026</title>
    ...
    <style>
        ...
        .voluntariado-edit-page {
            min-height: 100vh;
            padding: 34px 12px;
        }

        .voluntariado-edit-wrapper {
            max-width: 980px;
            margin: 0 auto;
        }

        .voluntariado-edit-card {
            background: #fff;
        ...
        .voluntariado-edit-header::after {
            content: "";
            position: absolute;
            left: 0;
            right: 0;
        ...
        .voluntariado-edit-subtitle {
            font-size: 1rem;
            color: rgba(255,255,255,0.9);
            margin-bottom: 0;
        }

        .voluntariado-edit-body {
            padding: 30px;
        }
